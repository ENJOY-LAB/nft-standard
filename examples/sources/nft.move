module examples::collection {
    ...
    use nft_standard::souffl3::{Self, NFT, SharedPublisher};
    ...
    const ENOT_BURNABLE: u64 = 0;
    const ENOT_MUTABLE: u64 = 1;
    ...
    public fun create_collection_display(
        ...
        let display_abyss = souffl3::create_display<Gekacha>(version, cap, publisher, ctx);
        display_abyss
    }
    ...
    public fun burn_by_owner(
        ...
        assert!(BURNABLE_BY_OWNER, ENOT_BURNABLE);
        souffl3::burn(Witness{}, nft);
    }
    ...
    public fun burn_by_creator(
        ...
        assert!(BURNABLE_BY_CREATOR, ENOT_BURNABLE);
        souffl3::burn(Witness{}, nft);
    }
    ...
    public fun mutate_name_image_by_creator(
        ...
        assert!(MUTATE_NAME_IMAGE_BY_CREATOR, ENOT_MUTABLE);
        souffl3::mutate_name_and_image_url(Witness{}, nft, name, image_url);
    }
}
